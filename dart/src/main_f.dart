...
void placeDistrict(
  ...
  currentCell.row = initialCell.row + 3;
  ...
  currentCell.row = initialCell.row + 13;
  currentCell.column = initialCell.column + 24;
...
void placeDistricts(
  ...
  for (int row = 0; row < city.rows; row += 20) {
    for (int column = 0; column < city.columns; column += 20) {
      placeDistrict(
        city,
        new Cell(row, column),
        projects,
